<div class="sidebar-menu-area">
    <ul class="sidebar-menu" id="sidebar-menu">
      ...
      <li class="dropdown">
        ...
        <li>
            <a href="{{ route('users-add') }}"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i> Add User</a>
          </li>
          <li>
            <a href="{{ route('users-list') }}"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Users List</a>
          </li>
        </ul>
      </li>
      <li class="dropdown">
